                ...
                <Row>
                    ...
                    <div className="skill-bx">
                        ...
                        <ul className="list">
                            ...
                            <li> <span>ReactJS & Next.js: </span>Skilled in building dynamic user interfaces, single-page applications, and server-side rendered applications with ReactJS and Next.js.</li>
                            <li> <span>Databases: </span>Experience with MySQL and MongoDB for database management.</li>
